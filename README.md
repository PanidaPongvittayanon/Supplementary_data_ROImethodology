...
3. code_for_ID_PM_IC.py
    This file contains a python code for performing the ID technique, applied for the PM and IC brain areas.
4. code_for_MO_CAU_PU.imj
    This is a Macro code for the imageJ (FIJI) program performed MO drawing technique in CAU and PU brain regions.              
